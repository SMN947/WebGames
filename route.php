<?php
    class Route {
        ...
        private static $loginRequired = null;
        ...
        * @param boolean $private       If login is needed, by default true
        *
        */
        public static function add($expression, $function, $private = true, $method = 'get'){
